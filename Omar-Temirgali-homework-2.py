...
def main():
    ...
    input_path = 'cleaned-flights.csv'
    ...
    with open(r'output_1.txt', 'w') as fp:
    ...
    with open(r'output_2.txt', 'w') as fp:
    ...
    with open(r'output_3.txt', 'w') as fp:
        fp.write(origin_with_largest_delay_jan)
    ...
    with open(r'output_4.txt', 'w') as fp:
        fp.write(airline_with_largest_delay_weekends)
    ...
    with open(r'output_5.txt', 'w') as fp:
        fp.write(airport_with_most_cancellation)
    ...
    with open(r'output_6.txt', 'w') as fp:
    ...
    with open(r'output_7.txt', 'w') as fp:
    ...
    with open(r'output_8.txt', 'w') as fp:
    ...
    with open(r'output_9.txt', 'w') as fp:
    ...
    with open(r'output_10.txt', 'w') as fp:
        for row in avg_dep_delay_per_airline_each_month:
            if row[0] == '1':
                fp.write("(%s, %.2f) in Jan\n" % (row[1], row[2]))
            elif row[0] == '2':
                fp.write("(%s, %.2f) in Feb\n" % (row[1], row[2]))
            elif row[0] == '3':
                fp.write("(%s, %.2f) in Mar\n" % (row[1], row[2]))
